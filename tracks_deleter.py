...
def log_message(message):
    ...
    try:
        with open("E:/Scripts/HealthGIS_Automation/logs/tracks_deletion.log", "a", encoding="utf-8") as log_file:
...
def main():
    ...
    log_message("=== TRACKS LAYER DELETION STARTED ===")
    ...
    try:
        ...
        layer_url = "https://esrirw.rw/server/rest/services/Hosted/tracks_0a7705de1c85423ba8ff60c0ad728abb/FeatureServer/0"
        ...
        log_message("=== TRACKS LAYER DELETION FINISHED SUCCESSFULLY ===")
        return True

    except Exception as e:
        error_msg = f"Error occurred: {str(e)}"
        log_message(error_msg)
        log_message("=== TRACKS LAYER DELETION FAILED ===")
        return False
